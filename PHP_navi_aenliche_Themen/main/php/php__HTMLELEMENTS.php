...
function ECHO_TAG_AUDIO ($audio, $url='')
{
	# => Function to return audio
	# Parameters:
	# - $src   : Directory and file name
	echo '<div class="audio1">
		<audio id="audio_with_controls" controls src="'.$audio.'"type="audio/ogg">',
             'Ihr Browser kann dieses Tondokument nicht wiedergeben.<br>
             Es enthält eine Aufführung der Europahymne. 
             Sie können es unter <a href="'.$url.'">Link-Addresse</a> abrufen.
		</audio>
	</div>';
}
