		...
		<div class="bg">
			...
			<div id="page">
				...
				<div class="banner">
					...
					<!--Deutsch/Englisch-->
					<div id="flag"  align="right" style="height: 50px; padding-right:5px; padding-bottom: 0px;">
					...
					<img style="padding-bottom:5px;  padding-left:15px; padding-top: 0px;"  src="images/Logo-uni-tuebingen.png" >
				</div>
				...
				<nav>
					...
					<ul>
						...
						<li>
							<a href="">Teilprojekte</a>
							<ul>
								<li>
									<a href="#">A: Entwicklungen</a>
									<ul>
										<li>
											<a href="#">A01</a>
										</li>
								...
								<li>
									<a href="bewertungen.html">C: Bewertungen</a>
									<ul>
										<li>
											<a href="#">C01</a>
										</li>
										...
										<li>
											<a href="c04.html">C04</a>
										</li>
										<li>
											<a href="http://localhost/php/shared/projekt_template.php?projekt=c04">C04</a>
										</li>
										<li>
											<a href="#">C05</a>
										</li>
										<li>
											<a href="c06.html">C06</a>
										</li>
										<li>
											<a href="http://localhost/php/shared/projekt_template.php?projekt=c06">C06</a>
										</li>
									</ul>
								</li>
								<li>
									<a href="#">Minigraduiertenkolleg</a>
								</li>
						...
						<div class="globus">
							<a style= "padding:0px; border:120px;" href="map.html"><img src="images/globe-green.png" height="40px" width="40px"> </a>
						</div>
					</ul>
				</nav>
				<!---------------Push-Up Menu-------------->
				...
				<div class="timeline">
					...
					<img src="images/timetable.jpg"  usemap="#timetable" alt="timetable" width="100%"/>
...
?>
				...
				<footer>
					<div class="Impressum">
						...
						<div class="rk">
							<img src="images/SFB1070-Logo.png" width="300px" height="300px">
						</div>
					</div>
